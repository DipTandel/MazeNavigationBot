...
;--------------------------------------------------------------------------------------------
PTH_A_INT       EQU   $CC                       ; Path detection threshold
PTH_B_INT       EQU   $CC                       ; ""
PTH_C_INT       EQU   $CC                       ; ""
PTH_D_INT       EQU   $CC                       ; ""

PTH_E_INT       EQU   $84                       ; If SENSOR_LINE < PTH_E_INT robot must shift right
PTH_F_INT       EQU   $A7                       ; If SENSOR_LINE > PTH_F_INT robot must shift left

INC_DIS         EQU   20                       ; INCREMENT distance
FWD_DIS         EQU   1000                      ; FORWARD distance
REV_DIS         EQU   300                      ; REVERSE distance
STR_DIS         EQU   1000                      ; STRAIGHT distance
TRN_DIS         EQU   15000                     ; TURN distance
